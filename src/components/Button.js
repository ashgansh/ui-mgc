...
export const SecondaryButton = ({
    ...
    return (
        <button
            ...
            disabled={disabled}
            className={classNames(
                "inline-flex items-center rounded-md border border-transparent bg-primary-50",
                "px-3 py-2 text-sm font-medium leading-4 text-primary-700 shadow-sm hover:opacity-90",
                "disabled:opacity-60",
                className
            )}
        >
